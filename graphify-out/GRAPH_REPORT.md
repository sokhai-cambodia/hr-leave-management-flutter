...
## Corpus Check
- 118 files · ~37,829 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1295 nodes · 1711 edges · 107 communities (89 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03e217f9`
...
Cohesion: 0.20
Nodes (13): ../app/routes/app_routes.dart, ../controllers/auth_controller.dart, FormState, GetView, AuthController, build, ForgotPasswordView, build (+5 more)
...
Cohesion: 0.07
Nodes (25): ../../../data/models/schedule_model.dart, ../../../data/repositories/schedule_repository.dart, DateTime, bridgeHoliday, data, fromJson, leaveDate, LeaveRecommendationItem (+17 more)
...
Cohesion: 0.05
Nodes (42): admin_crud_controller.dart, ../../../data/models/paginated_result.dart, ../../data/repositories/leave_types_repository.dart, ../../data/repositories/policies_repository.dart, ../../data/repositories/public_holidays_repository.dart, LeaveTypesRepository, createItem, deleteItem (+34 more)
...
Cohesion: 0.27
Nodes (10): LeaveRequestFormView, _LeaveRequestFormViewState, LeaveRequestsView, _LeaveRequestsViewState, AdminCrudView, _AdminCrudViewState, AdminFormDialog, _AdminFormDialogState (+2 more)
...
Cohesion: 0.18
Nodes (11): ../controllers/users_admin_controller.dart, ../../../data/models/user_model.dart, UserModel, dependencies, UsersAdminBinding, UsersAdminController, AdminUsersView, build (+3 more)
...
Cohesion: 0.21
Nodes (10): AdminCrudController, ../controllers/leave_balances_admin_controller.dart, ../../../data/models/leave_balance_model.dart, LeaveBalanceModel, dependencies, LeaveBalancesAdminController, AdminLeaveBalancesView, build (+2 more)
...
Cohesion: 0.50
Nodes (4): Phase 11 — Backend API Enhancements + Flutter Integration, Task 11.1 — Query-param filtering on `GET /leave-requests/` and `GET /leave-plan-requests/`, Task 11.2 — New `GET /approvals/pending-count`, Task 11.3 — New `GET /schedule/?year=<int>&month=<int 1-12>`
...
Cohesion: 0.10
Nodes (19): LeaveBalancesRepository, approvalsRepository, _authController, balances, balancesError, fetchBalances, fetchPendingApprovalsCount, fetchPendingRequestsCount (+11 more)
...
### Community 104 - "splash_view.dart"
Cohesion: 0.40
Nodes (5): build, createState, initState, SplashView, _SplashViewState

## Knowledge Gaps
- **790 isolated node(s):** `1. Objective`, `2. Tech Stack (per course guideline)`, `3. Commands`, `4. Project Structure`, `5. Code Style` (+785 more)
...
- **Why does `UserModel` connect `leave_request_detail_view.dart` to `admin_users_view.dart`?**
