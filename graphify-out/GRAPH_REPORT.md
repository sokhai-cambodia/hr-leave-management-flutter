...
## Corpus Check
- 87 files · ~24,773 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 836 nodes · 1125 edges · 65 communities (53 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eae52ac5`
...
- `Phase 3 — Leave Balances` --references--> `LeaveBalanceModel`  [EXTRACTED]
  tasks/plan.md → lib/data/models/leave_balance_model.dart
- `Phase 5 — Leave Plan Requests (multi-date lifecycle)` --references--> `LeavePlanRequestModel`  [EXTRACTED]
  tasks/plan.md → lib/data/models/leave_plan_request_model.dart
...
Cohesion: 0.10
Nodes (35): POST /api/v1/login/access-token (8-day session, no refresh), POST /login/test-token (session-restore validation), Material 3 + Single Seed Color Theme, POST /password-recovery/{email}, GET /recommends/leave-plan (AI Leave-Plan Recommender, headline feature), POST /reset-password/, Exception, hr-leave-management/frontend (existing React app, architectural reference) (+27 more)
...
Cohesion: 0.06
Nodes (33): app_routes.dart, auth_middleware.dart, ../../features/admin/views/admin_leave_balances_view.dart, ../../features/admin/views/admin_teams_view.dart, ../../features/admin/views/admin_users_view.dart, ../../features/admin/views/leave_types_view.dart, ../../features/admin/views/policies_view.dart, ../../features/approvals/views/approvals_view.dart (+25 more)
...
Cohesion: 0.06
Nodes (38): ../app/routes/app_routes.dart, ../controllers/auth_controller.dart, ../../../data/models/user_model.dart, FormState, GetView, AuthController, _authRepository, bootstrap (+30 more)
...
Cohesion: 0.08
Nodes (25): createRequest, currentRequest, deleteRequest, detailErrorMessage, errorMessage, fetchLeaveRequests, fetchLeaveTypes, fetchRequestDetail (+17 more)

### Community 7 - "Leave Recommendation Model & App Shell"
Cohesion: 0.07
Nodes (24): app_drawer.dart, DateTime?, bridgeHoliday, data, fromJson, leaveDate, LeaveRecommendationItem, LeaveRecommendationsModel (+16 more)
...
Cohesion: 0.07
Nodes (26): ../../../data/models/leave_type_model.dart, createRequest, currentRequest, deleteRequest, detailErrorMessage, errorMessage, fetchLeavePlanRequests, fetchLeaveTypes (+18 more)
...
Cohesion: 0.11
Nodes (18): bool get, LeavePlanRequestModel, _addPlannedDate, build, controller, createState, _descriptionController, dispose (+10 more)
...
Cohesion: 0.15
Nodes (12): AdminLeaveBalancesView, build, AdminTeamsView, build, AdminUsersView, build, build, LeaveTypesView (+4 more)
...
Cohesion: 0.09
Nodes (20): ../controllers/recommendations_controller.dart, ../../../data/models/leave_recommendation_model.dart, dependencies, changeYear, errorMessage, fetchRecommendations, isLoading, leaveTypeName (+12 more)
...
Cohesion: 0.20
Nodes (9): ../../core/storage/local_cache_service.dart, ../../../core/storage/secure_storage_service.dart, ../../../data/repositories/auth_repository.dart, ../../../data/repositories/leave_plan_requests_repository.dart, ../../../data/repositories/leave_requests_repository.dart, ../../../data/repositories/leave_types_repository.dart, ../../../data/repositories/recommends_repository.dart, ../../../data/repositories/teams_repository.dart (+1 more)

### Community 29 - "GetX Feature Bindings"
Cohesion: 0.17
Nodes (11): Bindings, ../controllers/leave_plan_requests_controller.dart, GetxController, InitialBinding, DashboardBinding, DashboardController, dependencies, LeavePlanRequestsBinding (+3 more)
...
Cohesion: 0.23
Nodes (12): SplashView, _SplashViewState, LeavePlanRequestFormView, _LeavePlanRequestFormViewState, LeavePlanRequestsView, _LeavePlanRequestsViewState, LeaveRequestDetailView, _LeaveRequestDetailViewState (+4 more)

### Community 32 - "Dashboard Controller"
Cohesion: 0.14
Nodes (12): ../controllers/dashboard_controller.dart, ../../../core/network/dio_client.dart, ../../../data/models/leave_balance_model.dart, ../../../data/repositories/leave_balances_repository.dart, LeaveBalancesRepository, dependencies, balances, balancesError (+4 more)
...
## Knowledge Gaps
- **452 isolated node(s):** `What this is`, `Running the backend for manual verification`, `Backend contract quirks that shape the code (verified against backend source, not just docs — see `tasks/plan.md` "Verified Backend Ground Truth")`, `Design tokens`, `Testing strategy` (+447 more)
...
- **Why does `tasks/plan.md — Implementation Plan` connect `App Architecture & Design Rationale` to `App Theme & Design Tokens`, `GetX Routes, Pages & Middleware Registry`, `AuthController & DI Bindings`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `AuthController` connect `AuthController & DI Bindings` to `App Architecture & Design Rationale`, `App Drawer Widget`, `GetX Routes, Pages & Middleware Registry`, `Dashboard View`, `GetX Feature Bindings`?**
