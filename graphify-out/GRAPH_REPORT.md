# Graph Report - hr-leave-management-flutter  (2026-08-08)
...
## Summary
- 1560 nodes · 2105 edges · 122 communities (119 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10a2ccaf`
...
Cohesion: 0.05
Nodes (40): ../constants/env.dart, dio, DioClient, onUnauthorized, _secureStorageService, SecureStorageService, deleteToken, getToken (+32 more)

### Community 5 - "Dio Client Auth Test Suite"
Cohesion: 0.22
Nodes (8): package:hr_leave_management/data/models/public_holiday_model.dart, package:hr_leave_management/data/models/schedule_model.dart, package:hr_leave_management/data/models/user_summary.dart, package:hr_leave_management/features/schedule/controllers/schedule_controller.dart, independenceDay, main, newYear, secondNewYearEvent
...
Cohesion: 0.09
Nodes (26): ../../leave_requests/views/leave_request_form_view.dart, _NavItem, _availableDaysSummary, balance, balances, build, color, DashboardView (+18 more)
...
Cohesion: 0.11
Nodes (18): _addPlannedDate, build, controller, createState, _descriptionController, dispose, _formatDate, _formKey (+10 more)
...
Cohesion: 0.25
Nodes (7): app/bindings/initial_binding.dart, app/routes/app_pages.dart, build, HrLeaveManagementApp, init, load, main
...
Cohesion: 0.06
Nodes (31): ../controllers/recommendations_controller.dart, ../../../data/models/leave_recommendation_model.dart, ../../../data/repositories/recommends_repository.dart, ../../leave_plan_requests/bindings/leave_plan_requests_binding.dart, ../../leave_plan_requests/controllers/leave_plan_requests_controller.dart, ../../leave_plan_requests/views/leave_plan_request_form_view.dart, dependencies, RecommendationsBinding (+23 more)
...
Cohesion: 0.12
Nodes (15): count, data, PaginatedResult, description, email, fromJson, fullName, id (+7 more)
...
Cohesion: 0.29
Nodes (5): package:flutter_test/flutter_test.dart, package:hr_leave_management/data/models/leave_balance_model.dart, package:hr_leave_management/features/leave_plan_requests/controllers/leave_plan_requests_controller.dart, main, main

### Community 58 - "App Launcher Icon (mdpi)"
Cohesion: 0.15
Nodes (12): Bindings, ../controllers/approvals_controller.dart, ../controllers/dashboard_controller.dart, InitialBinding, MainShellBinding, ApprovalsBinding, dependencies, ApprovalsController (+4 more)
...
Cohesion: 0.12
Nodes (15): dart:typed_data, DioException, HttpClientAdapter, package:hr_leave_management/core/network/dio_client.dart, package:hr_leave_management/core/storage/token_storage.dart, body, close, deleteToken (+7 more)
...
Cohesion: 0.18
Nodes (10): action, actor, AuditLogModel, createdAt, entityId, entityType, fromJson, id (+2 more)
...
Cohesion: 0.21
Nodes (12): ../app/routes/app_routes.dart, ../controllers/auth_controller.dart, FormState, GetView, AuthController, build, ForgotPasswordView, LoginView (+4 more)
...
### Community 96 - "State"
Cohesion: 0.13
Nodes (22): AuditLogsView, _AuditLogsViewState, LeavePlanRequestDetailView, _LeavePlanRequestDetailViewState, LeavePlanRequestFormView, _LeavePlanRequestFormViewState, LeavePlanRequestsView, _LeavePlanRequestsViewState (+14 more)
...
Cohesion: 0.25
Nodes (8): ../../auth/controllers/auth_controller.dart, build, controller, createState, hintText, _ObscurableField, _ObscurableFieldState, _obscure
...
Cohesion: 0.06
Nodes (30): ../controllers/public_holidays_admin_controller.dart, ../../../data/models/public_holiday_model.dart, ../../../data/models/schedule_model.dart, ../../../data/repositories/schedule_repository.dart, date, description, fromJson, id (+22 more)
...
Cohesion: 0.17
Nodes (10): ../controllers/schedule_controller.dart, ../../features/dashboard/controllers/dashboard_controller.dart, ../../features/leave_plan_requests/controllers/leave_plan_requests_controller.dart, ../../features/leave_requests/controllers/leave_requests_controller.dart, ../../features/schedule/controllers/schedule_controller.dart, dependencies, dependencies, ScheduleBinding (+2 more)
...
## Knowledge Gaps
- **976 isolated node(s):** `dependencies`, `AppPages`, `pages`, `Routes`, `splash` (+971 more)
