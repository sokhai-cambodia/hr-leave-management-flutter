...
class _LeavePlanRequestsViewState extends State<LeavePlanRequestsView> {
  ...
  Widget build(BuildContext context) {
    return AppShellScaffold(
      title: 'Leave Plan Requests',
      floatingActionButton: FloatingActionButton(
        onPressed: () => Get.to(() => const LeavePlanRequestFormView()),
      ...
      body: Obx(() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  ElevatedButton(
                    onPressed: () => controller.fetchLeavePlanRequests(isRefresh: true),
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemCount: controller.leavePlanRequests.length +
  ...
  Widget _buildPlanCard(LeavePlanRequestModel request) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => Get.to(() => LeavePlanRequestDetailView(requestId: request.id)),
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
